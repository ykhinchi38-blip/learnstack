...
export default function ProductCard({
  ...
  function openDetails() {
    if (opening) return;
    setOpening(true);
    trackEvent("product_viewed", productEventParams(product, "product_card"));
    ...
    <article className={styles.card} style={{ "--accent": cardAccent }}>
      ...
      <div className={styles.body}>
        ...
        <div className={styles.actions}>
          ...
          <Link href={product.gumroadUrl} target="_blank" rel="noopener noreferrer" className="brutalButton" onClick={() => trackEvent("gumroad_checkout_clicked", productEventParams(product, "product_card"))}>
            {buyLabel}
          </Link>
